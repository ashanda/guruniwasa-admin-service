...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">FREE VIDEO ACCESS REQUEST
         </h1>
      </div>
   ...
   <div class="row middle-hight">
      <div class="col-12">
         <div class="table-responsive  ">
            <table id="freeRequestTbl" class="table table-striped table-hover table-bordered">
               ...
               <tbody class="font-13 fw-500 align-items-center">
                  <tr>
                     ...
                     <td>
                        <a href="{{ route('web.payment.month') }}" class=" text-white
                           font-12 text-white rounded-pill py-2 px-3 bg-primary fw-500
                           align-items-center   hvr-shrink">View
                        </a>
                     </td>
                     <td> </td>
                     <td> </td>
                     <td>  <a href="{{ route('web.student.details') }}" class=" text-white
                        font-12 text-white rounded-pill py-2 px-3 bg-primary fw-500
                        align-items-center   hvr-shrink">View
                        </a>
                     </td>
