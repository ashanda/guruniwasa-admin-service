...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">DEPOSIT CASH TO BANK
      ...
      <div class="col-lg-3 col-sm-3 pt-lg-0 pt-3 text-end">
         ...
         <p>
            ...
            <i class="fa fa-plus"></i>  ADD DEPOSIT CASH
   ...
   <div class="row middle-hight">
      ...
      <div class="col-12">
         <div class="table-responsive  ">
            <table id="depositeCashTbl" class="table table-striped table-hover table-bordered">
