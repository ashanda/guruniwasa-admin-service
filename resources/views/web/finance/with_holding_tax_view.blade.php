...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-30 fw-bold text-uppercase text-purple">TAX PAYMENTS - WITHHOLDING TAX
                           ...
                           <div class="row">
                              <div class="col-12">
                                <div class="mb-2">
                                 ...
                                 <div class="mb-2">
                                    <label class="form-label font-14 fw-bold text-purple  mb-0">JOB ROLE/OTHER</label>
