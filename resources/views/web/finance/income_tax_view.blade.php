...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">TAX PAYMENTS - INCOME TAX
         </h1>
                     ...
                     <form action="">
                        <div class="modal-body modal-lg">
                           <div class="row">
                              <div class="col-12">
                                <div class="mb-2">
                                    <label class="form-label font-14 fw-bold text-purple  mb-0">Date</label>
                                    <input type="date" class="form-control fw-500 rounded-3 border-dark font-13"
                                       >
                                 </div>
                                 <div class="mb-2">
                                    <label class="form-label font-14 fw-bold text-purple  mb-0">Payment Details</label>
